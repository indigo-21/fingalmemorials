...
<body>
    <table class="top-content" style="">
        ...
        <tr>
            <td colspan="2">
                <h3 class="title-receipt">Credit Note Statement </h3>
            </td>
        </tr>
        <tr>
            ...
            <td style="border: 1px solid #000; padding:10px 20px;">
                ...
                <p><b>Credit Date: </b>{{date('d/m/Y', strtotime($order->created_at)) }}</p>
                ...
                <td colspan="3">
                    <table class="inner-content">
                        ...
                        <tbody> 
                                <tr>
                                    <td>
                                        <p>{{date('d/m/Y', strtotime($accountPosting->created_at)) }}</p>
                                    </td>
                                    <td>
